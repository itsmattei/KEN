...
class Training_splitted:
    ...
    def define_input(self, train_text, train_labels, val_text, val_labels):
        sentences_train = ["[CLS] " + str(sentence) + " [SEP]" for sentence in train_text]
        sentences_val = ["[CLS] " + str(sentence) + " [SEP]" for sentence in val_text]
...
class Training_to_split:
    ...
    def define_input(self, train_text, labels):
        sentences = ["[CLS] " + str(sentence) + " [SEP]" for sentence in train_text]
...
class Testing:
    ...
    def define_input(self):
        sentences_test = ["[CLS] " + str(sentence) + " [SEP]" for sentence in self.text]
